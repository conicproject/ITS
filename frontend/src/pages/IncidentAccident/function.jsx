...
function IncidentAccidentFunction() {
  const items = [
    ...
    { name: "การตรวจจับคนเดินบนทางพิเศษ", icon: "/assets/number/1.png", path: "/incident-accident/function/expressway" },
    { name: "การตรวจจับอุบัติเหตุบนท้องถนน", icon: "/assets/number/2.png", path: "/incident-accident/function/road-accident" },
    { name: "สิ่งของตกหล่นบนพื้นผิวจราจร", icon: "/assets/number/3.png", path: "/incident-accident/function/object-fall" },
  ];
