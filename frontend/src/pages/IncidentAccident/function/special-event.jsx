...
const [selectedSort, setSelectedSort] = useState("ล่าสุด");
  ...
  const stats = [
    { label: "กิจกรรมวันนี้", value: 50, icon: FaExclamationTriangle, color: "text-yellow-500" },
    { label: "กำลังดำเนินการ", value: 20, icon: FaCar, color: "text-red-500" },
    { label: "ผลกระทบสูง", value: 19, icon: FaWrench, color: "text-blue-500" },
    { label: "รอการยืนยัน", value: 11, icon: FaExclamationTriangle, color: "text-purple-500" },
  ];
