  ...
  const mockViolations = [
    {
      ...
      detail: 'ขับรถทับเส้นทึบก่อนถึงทางแยก',
    ...
    },
    {
      ...
      detail: 'ขับรถคร่อมเลน / ทับเส้นแบ่งช่องจราจร',
    ...
    },
    {
      ...
      detail: 'ขับทับเส้นก้างปลาบริเวณจุดเบี่ยง',
    ...
    },
    {
      ...
      status: 'สูง',
      location: 'แยกดินแดง',
      detail: 'ขับทับเส้นทึบเพื่อแทรกเข้าช่องจราจร',
      ...
      <div className="w-full mx-auto p-4 md:p-6 max-w-[1600px]">
        ...
        <div className="mb-4 flex items-center justify-between z-10">
            ...
            <div className="w-9 h-9 md:w-15 md:h-15 rounded-full border-[3px] border-red-600 flex items-center justify-center shrink-0 shadow-sm bg-white overflow-hidden">
              <img
                src="/assets/function_icon/enforcement_function/enforecment_10.png"
                alt="Enforcement Icon"
                className="w-full h-full object-cover"
              />
            </div>
              <h1 className="text-lg md:text-2xl font-black text-gray-800 line-clamp-1 tracking-tight">ขับรถทับเส้นจราจร</h1>
            </div>
