...
const EnforcementBlacklist = () => {
  ...
  const [violations, setViolations] = useState([
    { lpr: '1กก-9999', camera: 'CAM-BL-01', type: 'รถยนต์', time: '2025-01-24 14:25', status: 'สูง', location: 'แยกรัชดา-ห้วยขวาง', detail: 'รถยนต์ในบัญชีดำ (หมายจับคดีอาญา)', position: [13.7763, 100.5718] },
    { lpr: '2ขข-8888', camera: 'CAM-BL-02', type: 'รถตู้', time: '2025-01-24 14:30', status: 'สูง', location: 'จุดสกัดถนนวิภาวดี', detail: 'รถสวมทะเบียน / ป้ายทะเบียนปลอม', position: [13.8050, 100.5560] },
    { lpr: '3คค-7777', camera: 'CAM-BL-03', type: 'รถเก๋ง', time: '2025-01-24 14:45', status: 'ปานกลาง', location: 'แยกรัชดา-ลาดพร้าว', detail: 'เฝ้าระวังพิเศษ (หนีไฟแนนซ์/ขาดส่งค่างวดเกินกำหนด)', position: [13.8030, 100.5750] },
    { lpr: '4งง-6666', camera: 'CAM-BL-01', type: 'รถกระบะดัดแปลง', time: '2025-01-24 15:00', status: 'สูง', location: 'ด่านตรวจคนเข้าเมือง', detail: 'รถต้องสงสัยขนส่งสิ่งผิดกฎหมาย/ยาเสพติด', position: [13.7525, 100.5730] },
    { lpr: '5จจ-5555', camera: 'CAM-BL-04', type: 'รถหรู', time: '2025-01-24 15:15', status: 'สูง', location: 'ทางด่วนขั้นที่ 1', detail: 'ใบสั่งค้างชำระเกิน 50 ใบ (Blacklist จราจร)', position: [13.7300, 100.5400] },
    { lpr: '6ฉฉ-4444', camera: 'CAM-BL-05', type: 'รถจักรยานยนต์', time: '2025-01-24 15:30', status: 'สูง', location: 'แยกพระราม 9', detail: 'แจ้งรถหาย (Stolen Vehicle Alert)', position: [13.7576, 100.5654] },
    { lpr: '7ชช-3333', camera: 'CAM-BL-02', type: 'รถบรรทุก', time: '2025-01-24 15:45', status: 'ปานกลาง', location: 'ถนนพหลโยธิน', detail: 'ผู้ขับขี่ถูกเพิกถอนใบอนุญาต', position: [13.8200, 100.5680] }
  ]);
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden relative font-sans">
      ...
      <div className="w-full mx-auto p-4 md:p-6 flex flex-col h-full max-w-[1600px]">
        ...
        <div className={`shrink-0 transition-all duration-300 ease-in-out overflow-hidden z-30 ${showFilter ? 'max-h-[500px] opacity-100 mb-1' : 'max-h-0 opacity-0 mb-0 lg:max-h-none lg:opacity-100 lg:mb-1 lg:overflow-visible'}`}>
            <div className="p-1">
                <Filter type="redlight" onSearch={handleSearch} placeholder="ค้นหาทะเบียน/หมายจับ..." showDateRange={true} />
            </div>
        </div>
        ...
        <div className="flex flex-1 gap-5 md:gap-8 overflow-hidden relative z-0">
          ...
          <div className="hidden lg:block flex-none w-[400px] xl:w-[500px] 2xl:w-[600px]">
            ...
            <MapSidebar data={getMapData(selectedViolation || violations[0])} enableSequence={true} />
          </div>
        </div>
      </div>
    </div>
