...
const DetectRedlight = () => {
  ...
  const [violations, setViolations] = useState([
    { lpr: '1กก-1234', camera: 'CAM-RL-01', type: 'รถยนต์', time: '2025-01-24 14:25', status: 'สูง', location: 'แยกรัชดา-ห้วยขวาง', detail: 'ฝ่าสัญญาณไฟแดง (ขณะไฟแดง 3 วินาที)', position: [13.7763, 100.5718] },
    { lpr: '2ขข-5678', camera: 'CAM-RL-02', type: 'รถกระบะ', time: '2025-01-24 14:30', status: 'สูง', location: 'แยกพระราม 9', detail: 'ฝ่าสัญญาณไฟแดง (ด้วยความเร็วสูง)', position: [13.7576, 100.5654] },
    { lpr: '3คค-9012', camera: 'CAM-RL-03', type: 'รถจักรยานยนต์', time: '2025-01-24 14:45', status: 'สูง', location: 'แยกอโศก-เพชรบุรี', detail: 'จอดล้ำเส้นหยุดในขณะสัญญาณไฟแดง', position: [13.7485, 100.5630] },
    { lpr: '4งง-3456', camera: 'CAM-RL-01', type: 'รถแท็กซี่', time: '2025-01-24 15:00', status: 'ปานกลาง', location: 'แยกรัชดา-ห้วยขวาง', detail: 'เปลี่ยนช่องทางในเขตห้าม (เส้นทึบ)', position: [13.7763, 100.5718] },
    { lpr: '5จจ-7890', camera: 'CAM-RL-04', type: 'รถบรรทุก', time: '2025-01-24 15:15', status: 'สูง', location: 'แยกดินแดง', detail: 'ฝ่าสัญญาณไฟแดง', position: [13.7644, 100.5539] },
  ]);
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden relative font-sans">
      ...
      <div className="w-full mx-auto p-4 md:p-6 flex flex-col h-full max-w-[1600px]">
        ...
        <div className={`shrink-0 transition-all duration-300 ease-in-out overflow-hidden z-30 ${showFilter ? 'max-h-[500px] opacity-100 mb-1' : 'max-h-0 opacity-0 mb-0 lg:max-h-none lg:opacity-100 lg:mb-1 lg:overflow-visible'}`}>
            <div className="p-1">
                <Filter type="redlight" onSearch={handleSearch} placeholder="ค้นหาเลขทะเบียน..." showDateRange={true} />
            </div>
        </div>
