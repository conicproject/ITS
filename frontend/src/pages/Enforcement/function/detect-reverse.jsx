  ...
  const mockViolations = [
    {
      ...
      status: 'สูง',
      location: 'ปากซอยรัชดา 3',
      detail: 'ขับขี่ย้อนศรบนไหล่ทาง',
    ...
    },
    {
      ...
      detail: 'ขับรถย้อนศรเข้าช่องทางเดินรถทางเดียว (One-way)',
      position: [13.8050, 100.5750]
    },
    {
      lpr: '3คค-9012',
      camera: 'CAM-RV-03',
      ...
      status: 'สูง',
      location: 'ทางลงทางด่วนพระราม 9',
      detail: 'ถอยหลัง/ขับย้อนศรบริเวณทางลงทางด่วน',
    ...
    },
    {
      ...
      status: 'ปานกลาง',
      location: 'ปากซอยรัชดา 3',
      detail: 'ขับขี่ย้อนศรเพื่อลัดเข้าซอย',
      position: [13.7763, 100.5718]
    },
    {
      lpr: '5จจ-7890',
      ...
      detail: 'ขับรถย้อนศรในช่องทางด่วน (Main road)',
      ...
      <div className="w-full mx-auto p-4 md:p-6 max-w-[1600px]">
        ...
        <div className="mb-4 flex items-center justify-between z-10">
            ...
            <div className="w-9 h-9 md:w-15 md:h-15 rounded-full border-[3px] border-red-600 flex items-center justify-center shrink-0 shadow-sm bg-white overflow-hidden">
              <img
                src="/assets/function_icon/enforcement_function/enforecment_12.png"
                alt="Enforcement Icon"
                className="w-full h-full object-cover"
              />
            </div>
              <h1 className="text-lg md:text-2xl font-black text-gray-800 line-clamp-1 tracking-tight">ขับรถย้อนศร</h1>
            </div>
