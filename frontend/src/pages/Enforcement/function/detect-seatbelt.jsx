  ...
  const mockViolations = [
    {
      ...
      detail: 'ผู้ขับขี่ไม่คาดเข็มขัดนิรภัย',
    ...
    },
    {
      ...
      detail: 'ผู้โดยสารเบาะหน้าไม่คาดเข็มขัดนิรภัย',
    ...
    },
    {
      ...
      detail: 'ผู้ขับขี่และผู้โดยสารไม่คาดเข็มขัดนิรภัย',
    ...
    },
    {
      ...
      status: 'ปานกลาง',
      location: 'แยกรัชดา-ห้วยขวาง',
      detail: 'ผู้โดยสารตอนหลังไม่คาดเข็มขัดนิรภัย',
      position: [13.7763, 100.5718]
    },
    {
      lpr: '5จจ-7890',
      ...
      <div className="w-full mx-auto p-4 md:p-6 max-w-[1600px]">
        ...
        <div className="mb-4 flex items-center justify-between z-10">
            ...
            <div className="w-9 h-9 md:w-15 md:h-15 rounded-full border-[3px] border-red-600 flex items-center justify-center shrink-0 shadow-sm bg-white overflow-hidden">
              <img
                src="/assets/function_icon/enforcement_function/enforecment_13.png"
                alt="Enforcement Icon"
                className="w-full h-full object-cover"
              />
            </div>
              <h1 className="text-lg md:text-2xl font-black text-gray-800 line-clamp-1 tracking-tight">การไม่คาดเข็มขัดนิรภัย</h1>
            </div>
