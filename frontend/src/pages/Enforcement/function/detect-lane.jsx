...
const DetectLane = () => {
  ...
  const [violations, setViolations] = useState([
    { lpr: '1กก-1234', camera: 'CAM-LN-01', type: 'รถยนต์', time: '2025-01-24 14:25', status: 'สูง', location: 'แยกรัชดา-ห้วยขวาง', detail: 'เปลี่ยนช่องทางในเขตห้าม (เส้นทึบ)', position: [13.7763, 100.5718] },
    { lpr: '2ขข-5678', camera: 'CAM-LN-02', type: 'รถกระบะ', time: '2025-01-24 14:30', status: 'ปานกลาง', location: 'สะพานข้ามแยกพระราม 9', detail: 'ขับคร่อมเลน / ไม่ชิดขอบทางซ้าย', position: [13.7576, 100.5654] },
    { lpr: '3คค-9012', camera: 'CAM-LN-03', type: 'รถบรรทุก', time: '2025-01-24 14:45', status: 'สูง', location: 'ทางด่วนขั้นที่ 2', detail: 'รถบรรทุกวิ่งในช่องทางขวาสุด', position: [13.7650, 100.5690] },
    { lpr: '4งง-3456', camera: 'CAM-LN-01', type: 'รถจักรยานยนต์', time: '2025-01-24 15:00', status: 'สูง', location: 'อุโมงค์ห้วยขวาง', detail: 'ฝ่าฝืนห้ามรถจักรยานยนต์ใช้อุโมงค์', position: [13.7763, 100.5718] },
    { lpr: '5จจ-7890', camera: 'CAM-LN-04', type: 'รถยนต์', time: '2025-01-24 15:15', status: 'ต่ำ', location: 'แยกอโศก', detail: 'หยุดรถทับเส้นทึบ', position: [13.7364, 100.5600] },
  ]);
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden relative font-sans">
      ...
      <div className="w-full mx-auto p-4 md:p-6 flex flex-col h-full max-w-[1600px]">
        ...
        <div className={`shrink-0 transition-all duration-300 ease-in-out overflow-hidden z-30 ${showFilter ? 'max-h-[500px] opacity-100 mb-1' : 'max-h-0 opacity-0 mb-0 lg:max-h-none lg:opacity-100 lg:mb-1 lg:overflow-visible'}`}>
            <div className="p-1">
                <Filter type="lane" onSearch={handleSearch} placeholder="ค้นหาเลขทะเบียน..." showDateRange={true} />
            </div>
        </div>
