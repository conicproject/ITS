...
const DetectLane = () => {
  ...
  const fetchLaneViolations = async (filters = {}) => {
    setLoading(true);
    try {
      ...
      console.error("fetchLaneViolations error:", err);
      setViolations([]);
    } finally {
      setLoading(false);
    }
  ...
  const handleSearch = (filters) => fetchLaneViolations(filters);
    ...
    <div className="w-full h-screen bg-gray-50 relative font-sans overflow-y-auto overflow-x-hidden pb-10">
      ...
      <div className="w-full mx-auto p-4 md:p-6 max-w-[1600px]">
        ...
        <div className={`transition-all duration-300 overflow-hidden ${
          ...
          <Filter type="lane" onSearch={handleSearch} />
        </div>
