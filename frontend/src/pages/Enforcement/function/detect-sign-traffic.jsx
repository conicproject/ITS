  ...
  const mockViolations = [
    {
      ...
      detail: 'ฝ่าฝืนป้ายห้ามเลี้ยวซ้าย (No Left Turn)',
    ...
    },
    {
      ...
      detail: 'ฝ่าฝืนป้ายห้ามกลับรถ (No U-Turn)',
    ...
    },
    {
      ...
      status: 'สูง',
      location: 'ซอยสุขุมวิท 21',
      detail: 'ฝ่าฝืนป้ายห้ามเข้า (No Entry / One Way)',
    ...
    },
    {
      ...
      status: 'สูง',
      location: 'แยกรัชดา-ห้วยขวาง',
      detail: 'ไม่หยุดรถที่ป้ายหยุด (Stop Sign)',
      position: [13.7763, 100.5718]
    },
    {
      lpr: '5จจ-7890',
      ...
      detail: 'ฝ่าฝืนป้ายจำกัดความเร็วเฉพาะจุด',
      ...
      <div className="w-full mx-auto p-4 md:p-6 max-w-[1600px]">
        ...
        <div className="mb-4 flex items-center justify-between z-10">
            ...
            <div className="w-9 h-9 md:w-15 md:h-15 rounded-full border-[3px] border-red-600 flex items-center justify-center shrink-0 shadow-sm bg-white overflow-hidden">
              <img
                src="/assets/function_icon/enforcement_function/enforecment_14.png"
                alt="Enforcement Icon"
                className="w-full h-full object-cover"
              />
            </div>
              <h1 className="text-lg md:text-2xl font-black text-gray-800 line-clamp-1 tracking-tight">ไม่ปฏิบัติตามป้ายจราจร</h1>
            </div>
...
export default DetectSignTraffic;